...
#define ATTR_JSON_MOBILE_STATUS_VALUE "MOBILE_STATUS_VALUE"

#define ATTR_JSON_ID_DEVICE "idSmartDevice"
#define ATTR_JSON_NAME_DEVICE "nameSmartDevice"
...
#define MESSAGE_TYPE_MOBILE_STATUS_VALUE "MOBILE_STATUS_VALUE"
