...
class JsonParser_smart_device_status_value_Test : public ::testing::Test
{
public:
protected:
    virtual void SetUp()
...
TEST_F(JsonParser_smart_device_status_value_Test, TestparseDataSmartDeviceJson_RESULT_OK)
{
    bool status = false;
