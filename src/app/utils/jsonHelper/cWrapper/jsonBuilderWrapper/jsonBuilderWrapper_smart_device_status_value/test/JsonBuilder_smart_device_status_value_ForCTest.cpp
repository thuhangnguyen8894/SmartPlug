...
class JsonBuilder_smart_device_status_value_ForCTest : public ::testing::Test
{
public:
protected:
    virtual void SetUp()
...
TEST_F(JsonBuilder_smart_device_status_value_ForCTest, TestbuildJsonForC_RESULT_FAILURE_2)
{
    char* jsonString = NULL;
...
TEST_F(JsonBuilder_smart_device_status_value_ForCTest, TestbuildJsonForC_RESULT_FAILURE_3)
{
    char* jsonString = NULL;
