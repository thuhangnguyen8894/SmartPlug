 ...
 */
TEST_F(JsonCommon_smart_device_status_value_Test, TestsplitWordRegex_RESULT_OK)
{
 ...
 * Expected Result: false
 */
TEST_F(JsonCommon_smart_device_status_value_Test, TestisSensorMessage_FAILURE_COLON_SPLITTER)
{
    std::string message("SMART_DEVICE_STATUS_VALUE;SD001.OFF.UNACTIVE.R0001;192.168.0.100/8800;TI00000001_1/18/2017_21/59/00");
    bool status = isSensorMessage(message);
    EXPECT_FALSE(status);
 ...
 * Expected Result: false
 */
TEST_F(JsonCommon_smart_device_status_value_Test, TestisSensorMessage_FAILURE_SLASH_SPLITTER)
{
    std::string message("SMART_DEVICE_STATUS_VALUE;SD001:OFF:UNACTIVE:R0001;192.168.0.100:8800;TI00000001_1:18:2017_21:59:00");
    bool status = isSensorMessage(message);
    EXPECT_FALSE(status);
 ...
 * Expected Result: false
 */
TEST_F(JsonCommon_smart_device_status_value_Test, TestisSensorMessage_FAILURE_UNDERSCORS_SPLITTER)
{
 ...
 */
TEST_F(JsonCommon_smart_device_status_value_Test, TestconvertMessageTypeToStr_RESULT_OK)
{
 ...
 * Expected Result: MESSAGE_TYPE_DEFAULT
 */
TEST_F(JsonCommon_smart_device_status_value_Test, TestconvertMessageTypeToStr_RESULT_FAILURE)
{
