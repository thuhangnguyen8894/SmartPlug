...
static PyObject *
_cffi_f_insert_to_table_Device_Timer_ForC(PyObject *self, PyObject *arg0)
{
  SmartDeviceInfo const * x0;
  Py_ssize_t datasize;
  _Bool result;
  ...
  _cffi_restore_errno();
  { result = insert_to_table_Device_Timer_ForC(x0); }
  _cffi_save_errno();
...
static PyObject *
_cffi_f_insert_to_table_Timer_ForC(PyObject *self, PyObject *arg0)
{
  SmartDeviceInfo const * x0;
  Py_ssize_t datasize;
  _Bool result;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = insert_to_table_Timer_ForC(x0); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
static PyObject *
_cffi_f_select_idTimer_to_table_Timer_ForC(PyObject *self, PyObject *arg0)
{
  SmartDeviceInfo * x0;
  Py_ssize_t datasize;
  _Bool result;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = select_idTimer_to_table_Timer_ForC(x0); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
static PyMethodDef _cffi_methods[] = {
  ...
  {"insert_to_table_Device_Timer_ForC", _cffi_f_insert_to_table_Device_Timer_ForC, METH_O, NULL},
  {"insert_to_table_Timer_ForC", _cffi_f_insert_to_table_Timer_ForC, METH_O, NULL},
  {"select_idTimer_to_table_Timer_ForC", _cffi_f_select_idTimer_to_table_Timer_ForC, METH_O, NULL},
...
PyMODINIT_FUNC
PyInit___cffi_DBSmartDevice(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init__cffi_DBSmartDevice(void)
{
  PyObject *lib;
  lib = Py_InitModule("__cffi_DBSmartDevice", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
