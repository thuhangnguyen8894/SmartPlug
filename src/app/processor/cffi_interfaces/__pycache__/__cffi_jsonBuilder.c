...
static PyObject *
_cffi_f_buildJsonForC(PyObject *self, PyObject *args)
{
  char const * x0;
  char * * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_ParseTuple(args, "OO:buildJsonForC", &arg0, &arg1))
    return NULL;
...
static PyMethodDef _cffi_methods[] = {
  {"buildJsonForC", _cffi_f_buildJsonForC, METH_VARARGS, NULL},
...
PyMODINIT_FUNC
PyInit___cffi_jsonBuilder(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init__cffi_jsonBuilder(void)
{
  PyObject *lib;
  lib = Py_InitModule("__cffi_jsonBuilder", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
