...
jsonCommon_cffi.cdef("""
    ...
    #define SMART_PLUG_MESSAGE_TYPE ...
    #define SMART_PLUG_MESSAGE_VALUE_ON ...
    #define SMART_PLUG_MESSAGE_VALUE_OFF ...

    #define ATTR_JSON_MESSAGE_TYPE ...
    #define ATTR_JSON_SMART_PLUG_STATUS ...
    ...
    #define MESSAGE_TYPE_CONTROL_SMART_PLUG_STR ...
