package com.nguyenthuhang.smartplug.api;

import com.nguyenthuhang.smartplug.api.RestClient.RequestMethod;
...
public class APIService {
	...
	public class ApiAsyncTask extends AsyncTask<RequestMethod, Void, Boolean> {
		private int ApiID;

		@Override
		protected Boolean doInBackground(RequestMethod... params) {
			try {
